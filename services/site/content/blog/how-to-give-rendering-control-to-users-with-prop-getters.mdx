...
meta:
  keywords:
    - javascript
    - react
bannerMediaId: unsplash/photo-1464348123218-0ee63dfd2746
...
![dog wagging the tail while waiting](/media/kentcdodds.com/content/blog/how-to-give-rendering-control-to-users-with-prop-getters/0.gif)
...
![React toggled logo](/media/w_1600/kentcdodds.com/content/blog/how-to-give-rendering-control-to-users-with-prop-getters/1.png)
