...
meta:
  keywords:
    ...
    - reset state
    - key prop
bannerMediaId: unsplash/photo-1455612693675-112974d4880b
...
[![Clicking a toggle component, then a reset button which shows no animation on reset](/media/kentcdodds.com/content/blog/the-state-initializer-pattern/key-reset.gif)](https://advanced-react-patterns-next.netlify.app/isolated/examples/resetting-via-key-prop.tsx)

**With the state initializer pattern** (notice there is an animation):

[![Clicking a toggle component, then a reset button which shows no animation on reset](/media/kentcdodds.com/content/blog/the-state-initializer-pattern/state-initializer-pattern.gif)](https://advanced-react-patterns-next.netlify.app/isolated/final/05.extra-1.tsx)
