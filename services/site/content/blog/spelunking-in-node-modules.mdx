...
meta:
  keywords:
    - javascript
    - Nodejs
bannerCloudinaryId: kentcdodds.com/content/blog/spelunking-in-node-modules/banner
...
![Wow](/media/w_1600/kentcdodds.com/content/blog/spelunking-in-node-modules/0.jpg)
