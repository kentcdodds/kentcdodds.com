...
meta:
  keywords:
    ...
    - Command Line
    - Node
bannerCloudinaryId: kentcdodds.com/content/blog/tips-for-making-a-cli-based-tool-with-node/banner
---
...
![See you on Twitter!](/media/w_1600/kentcdodds.com/content/blog/tips-for-making-a-cli-based-tool-with-node/0.png)
