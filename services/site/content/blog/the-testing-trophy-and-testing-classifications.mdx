...
meta:
  keywords:
    ...
    - end-to-end tests
    - react
bannerMediaId: unsplash/photo-1527871454777-032ec3f75edc
...
<div style={{ backgroundColor: 'white', padding: 30, borderRadius: '0.5rem' }}>
	...
	Static](/media/w_1600/kentcdodds.com/blog/the-testing-trophy-and-testing-classifications/trophy_wx9aen.png)
</div>
