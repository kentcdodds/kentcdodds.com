...
meta:
  keywords:
    ...
    - node.js
    - memory leak
bannerMediaId: unsplash/photo-1520637102912-2df6bb2aec6d
...
![Screenshot of the Fly metrics UI on a mobile device showing two firecracker graphs, one for load average and one for memory usage. There are two clear spikes of each and it looks not so good.](/media/w_1600/kentcdodds.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/two-spikes)
...
<ThemedBlogImage
	...
	darkMediaId="kentcdodds.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/server-timing"
	lightMediaId="kentcdodds.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/server-timing-light"
	imgProps={{
...
<ThemedBlogImage
	transparentBackground
	darkMediaId="kentcdodds.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/heapf32"
	lightMediaId="kentcdodds.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/heapf32-light"
	imgProps={{
...
<ThemedBlogImage
	transparentBackground
	darkMediaId="kentcdodds.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/typed-arrays"
	lightMediaId="kentcdodds.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/typed-arrays-light"
	imgProps={{
...
<ThemedBlogImage
	transparentBackground
	darkMediaId="kentcdodds.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/cloudinary-strings"
	lightMediaId="kentcdodds.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/cloudinary-strings-light"
	imgProps={{
...
<ThemedBlogImage
	transparentBackground
	darkMediaId="kentcdodds.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/tls-connections"
	lightMediaId="kentcdodds.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/tls-connections-light"
	imgProps={{
