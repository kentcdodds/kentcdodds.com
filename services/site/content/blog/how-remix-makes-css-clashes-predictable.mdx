...
meta:
  keywords:
    ...
    - css-in-js
    - tailwind
bannerMediaId: unsplash/photo-1543393716-375f47996a77
...
![Gif showing a link tag getting removed when navigating from the about page to the homepage](/media/kentcdodds.com/blog/how-remix-makes-css-clashes-impossible/css-link-removed.gif)
