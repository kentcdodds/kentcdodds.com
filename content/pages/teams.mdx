...
<ThemedBlogImage
  darkCloudinaryId="kentcdodds.com/content/teams/team-chooser-dark"
  lightCloudinaryId="kentcdodds.com/content/teams/team-chooser-light"
  imgProps={{
    alt: 'UI for choosing a team showing three Koala options: Red, Blue, and Yellow',
  }}
/>
