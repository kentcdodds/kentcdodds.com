...
meta:
  keywords:
    ...
    - Command Line
    - Node
bannerImageId: kentcdodds.com/content/blog/tips-for-making-a-cli-based-tool-with-node/banner
---
...
![See you on Twitter!](/media/kentcdodds.com/content/blog/tips-for-making-a-cli-based-tool-with-node/0.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
