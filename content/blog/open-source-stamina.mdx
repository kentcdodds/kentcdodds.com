...
meta:
  keywords:
    ...
    - javascript
    - open source
bannerCloudinaryId: kentcdodds.com/content/blog/open-source-stamina/banner.jpg
---
...
<callout-info class="asside">
  Thanks to [TJ Holowaychuk](https://twitter.com/tjholowaychuk), [Friedel
  Ziegelmayer](https://twitter.com/dignifiedquire), and [Mark
  Trostler](https://twitter.com/zzoass) for reviewing this post.
</callout-info>
