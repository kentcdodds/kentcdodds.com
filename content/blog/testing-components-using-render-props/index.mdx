...
meta:
  keywords:
    ...
    - testing
    - react
bannerImageId: unsplash/photo-1500479694472-551d1fb6258d
...
![UI, Service, Unit](/media/kentcdodds.com/content/blog/testing-components-using-render-props/0.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
