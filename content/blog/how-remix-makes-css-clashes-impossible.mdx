---
title: How Remix makes CSS clashes impossible
date: 2021-10-13
description:
...
Before we get started, I should probably clarify the title a little bit really
quick. You can always get CSS to clash, no matter the tool you use (yep, I'm
talking about you CSS-modules and CSS-in-JS). It's simple:
...
/* then later */
button {
  color: blue; /* oh no! this clashes with what's above! */
}
```

What I mean is that with Remix you'll never have a situation where a change in
one CSS file has unexpected impacts on other pages in your app, without any
runtime or class name mangling. It's pretty cool. Now that we understand each
