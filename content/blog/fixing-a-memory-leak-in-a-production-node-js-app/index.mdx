...
meta:
  keywords:
    ...
    - node.js
    - memory leak
bannerImageId: unsplash/photo-1520637102912-2df6bb2aec6d
...
![Screenshot of the Fly metrics UI on a mobile device showing two firecracker graphs, one for load average and one for memory usage. There are two clear spikes of each and it looks not so good.](/media/blog/fixing-a-memory-leak-in-a-production-node-js-app/two-spikes?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
<ThemedBlogImage
	...
	darkImageId="kentcdodds.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/server-timing"
	lightImageId="kentcdodds.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/server-timing-light"
	imgProps={{
...
<ThemedBlogImage
	transparentBackground
	darkImageId="kentcdodds.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/heapf32"
	lightImageId="kentcdodds.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/heapf32-light"
	imgProps={{
...
<ThemedBlogImage
	transparentBackground
	darkImageId="kentcdodds.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/typed-arrays"
	lightImageId="kentcdodds.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/typed-arrays-light"
	imgProps={{
...
<ThemedBlogImage
	transparentBackground
	darkImageId="kentcdodds.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/cloudinary-strings"
	lightImageId="kentcdodds.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/cloudinary-strings-light"
	imgProps={{
...
<ThemedBlogImage
	transparentBackground
	darkImageId="kentcdodds.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/tls-connections"
	lightImageId="kentcdodds.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/tls-connections-light"
	imgProps={{
