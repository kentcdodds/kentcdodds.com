...
bannerImageId: kentcdodds.com/content/blog/unit-vs-integration-vs-e2e-tests/banner
...
<div style={{ backgroundColor: 'white', padding: 30, borderRadius: '0.5rem' }}>
	[![The Testing
	Trophy](/media/kentcdodds.com/content/blog/unit-vs-integration-vs-e2e-tests/testing-trophy.png?tr=f_auto,q_auto,dpr_2.0,w_1600)](https://testingjavascript.com)
</div>
...
[![The Testing Trophy with arrows indicating the trade-offs](/media/kentcdodds.com/content/blog/unit-vs-integration-vs-e2e-tests/confidence-coefficient.png?tr=f_auto,q_auto,dpr_2.0,w_1600)](https://slides.com/kentcdodds/confident-react#/3/5)
