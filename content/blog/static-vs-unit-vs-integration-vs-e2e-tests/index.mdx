...
<div style={{ backgroundColor: 'white', padding: 30, borderRadius: '0.5rem' }}>
	[![The Testing
	Trophy](/media/image/upload/v1625033466/kentcdodds.com/content/blog/unit-vs-integration-vs-e2e-tests/testing-trophy.png)](https://testingjavascript.com)
</div>
...
[![The Testing Trophy with arrows indicating the trade-offs](/media/image/upload/v1625033467/kentcdodds.com/content/blog/unit-vs-integration-vs-e2e-tests/confidence-coefficient.png)](https://slides.com/kentcdodds/confident-react#/3/5)
