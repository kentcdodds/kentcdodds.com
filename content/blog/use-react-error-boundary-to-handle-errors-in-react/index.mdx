...
bannerImageId: kentcdodds.com/content/blog/use-react-error-boundary-to-handle-errors-in-react/banner
...
![Chrome window with nothing but white](/media/kentcdodds.com/content/blog/use-react-error-boundary-to-handle-errors-in-react/white-screen.png?tr=f_auto,q_auto,dpr_2.0,w_1600)

If you run this with create-react-app's error overlay (during development),
you'll get this:

![TypeError Cannot read property 'toUpperCase' of undefined](/media/kentcdodds.com/content/blog/use-react-error-boundary-to-handle-errors-in-react/error-overlay.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
