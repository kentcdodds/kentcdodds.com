...
![Gif showing a link tag getting removed when navigating from the about page to the homepage](/media/blog/how-remix-makes-css-clashes-impossible/css-link-removed.gif?tr=f_auto,q_auto,w_1600)
