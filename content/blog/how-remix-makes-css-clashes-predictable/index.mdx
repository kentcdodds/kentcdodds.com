...
![Gif showing a link tag getting removed when navigating from the about page to the homepage](/media/image/upload/kentcdodds.com/blog/how-remix-makes-css-clashes-impossible/css-link-removed.gif)
