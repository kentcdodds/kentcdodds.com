...
date: 2018-12-24
description: How can we prepare our tests for React's new hooks feature?
meta:
  keywords:
    - javascript
    - react
...
translations:
  - language: 한국어
    link: https://edykim.com/ko/post/react-hooks-whats-going-to-happen-to-my-tests
bannerCloudinaryId: unsplash/photo-1538291397218-01e8830ddc68
bannerCredit: Photo by [Mat Reding](https://unsplash.com/photos/OFVMOjjjIic)
---
