...
meta:
  keywords:
    ...
    - reset state
    - key prop
bannerImageId: unsplash/photo-1455612693675-112974d4880b
...
[![Clicking a toggle component, then a reset button which shows no animation on reset](/media/image/upload/v1636121505/kentcdodds.com/content/blog/the-state-initializer-pattern/key-reset.gif)](https://advanced-react-patterns-next.netlify.app/isolated/examples/resetting-via-key-prop.tsx)

**With the state initializer pattern** (notice there is an animation):

[![Clicking a toggle component, then a reset button which shows no animation on reset](/media/image/upload/v1636121497/kentcdodds.com/content/blog/the-state-initializer-pattern/state-initializer-pattern.gif)](https://advanced-react-patterns-next.netlify.app/isolated/final/05.extra-1.tsx)
...
removed it from my [Advanced React Patterns](https://epicreact.dev/patterns)
