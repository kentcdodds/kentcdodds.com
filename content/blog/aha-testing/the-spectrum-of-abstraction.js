...
function TheSpectrumOfAbstraction() {
    return (<div style={{ width: '100%', marginTop: 10, marginBottom: 40 }}>
			<div style={{
            width: '100%',
            display: 'flex',
            ...
            width: '100%',
            height: 20,
            backgroundImage: 'linear-gradient(-213deg, rgb(94, 49, 220) 0%, rgb(49, 85, 220) 100%)',
        }}/>
			<div style={{
            marginTop: 10,
            color: 'rgb(71,67,220)',
            background: 'linear-gradient(-213deg, rgb(94, 49, 220) 0%, rgb(49, 85, 220) 100%)',
...
exports.default = TheSpectrumOfAbstraction;
