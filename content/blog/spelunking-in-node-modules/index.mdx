...
meta:
  keywords:
    - javascript
    - Nodejs
bannerImageId: kentcdodds.com/content/blog/spelunking-in-node-modules/banner
...
<callout-info class="aside">
	...
	gist](https://gist.github.com/kentcdodds/0d02347d420459f4aac2cba4b3e8bef7#file-downshift-error-log)
	for the full output.
</callout-info>
...
<callout-info class="aside">
	...
	of the last
	command](https://gist.github.com/kentcdodds/0d02347d420459f4aac2cba4b3e8bef7#file-npx-clock-node_modules).
</callout-info>

![Wow](/media/kentcdodds.com/content/blog/spelunking-in-node-modules/0.jpg?tr=f_auto,q_auto,dpr_2.0,w_1600)
