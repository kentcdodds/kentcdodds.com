...
meta:
  keywords:
    ...
    - router
    - authentication
bannerImageId: unsplash/photo-1461838432805-dff34fe2d8cb
...
That's it.
[Most apps](https://x.com/kentcdodds/status/1131184429169168387) which
...
<callout-info class="aside">
	...
	bookshelf repo](https://github.com/kentcdodds/bookshelf) which I made for my
	[Build ReactJS Applications Workshop](https://epicreact.dev/app).
</callout-info>
