...
So, I made a util file for interacting with fly:

```ts filename=app/utils/fly.server.ts
import fs from 'fs'
import os from 'os'
...
"Went off pretty much without issue" that is... Until I tried deploying to new
regions... More to the story later. I'm still working through this.
