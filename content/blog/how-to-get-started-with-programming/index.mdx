...
meta:
  keywords:
    ...
    - coding
    - beginner
bannerImageId: unsplash/photo-1510280781386-572b2438f88b
...
![developer tools menu](/media/kentcdodds.com/content/blog/how-to-get-started-with-programming/devtools-menu.png?tr=f_auto,q_auto,dpr_2.0,w_1600)

Clicking on that "Developer Tools" menu option opens up the Chrome Developer
Tools:

![developer tools elements panel](/media/kentcdodds.com/content/blog/how-to-get-started-with-programming/devtools.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
![developer tools console panel](/media/kentcdodds.com/content/blog/how-to-get-started-with-programming/devtools-console.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
![1 + 2 evaluating to 3](/media/kentcdodds.com/content/blog/how-to-get-started-with-programming/1plus2.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
![web page with something logged to the console](/media/kentcdodds.com/content/blog/how-to-get-started-with-programming/my-first-program.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
first follow: [@kentcdodds](https://x.com/kentcdodds) 😉

Good luck to you!

P.S. If you'd like to see more beginner material and tutorials from me, please
[ask me about it on twitter](https://x.com/intent/post?url=https%3A%2F%2Fkentcdodds.com%2Fblog%2Fhow-to-get-started-with-programming&text=Hey,%20@kentcdodds,%20I%27d%20love%20it%20if%20you%20could%20create%20more%20beginner%20programmer%20content!)
