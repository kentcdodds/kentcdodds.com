...
![developer tools menu](/media/blog/how-to-get-started-with-programming/devtools-menu.png?tr=f_auto,q_auto,dpr_2.0,w_1600)

Clicking on that "Developer Tools" menu option opens up the Chrome Developer
Tools:

![developer tools elements panel](/media/blog/how-to-get-started-with-programming/devtools.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
![developer tools console panel](/media/blog/how-to-get-started-with-programming/devtools-console.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
![1 + 2 evaluating to 3](/media/blog/how-to-get-started-with-programming/1plus2.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
![web page with something logged to the console](/media/blog/how-to-get-started-with-programming/my-first-program.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
