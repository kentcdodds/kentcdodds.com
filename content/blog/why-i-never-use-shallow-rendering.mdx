c--- title: Why I Never Use Shallow Rendering date: 2018-07-23 description:
Tests should help me be confident that my application is working and there are
better ways to do that than shallow rendering. meta: keywords: - javascript -
react - testing bannerCloudinaryId:
kentcdodds.com/content/blog/why-i-never-use-shallow-rendering/banner.jpg
