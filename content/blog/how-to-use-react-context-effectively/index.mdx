...
bannerImageId: unsplash/photo-1534870439272-475575042b61
...
![dispatch type getting autocompleted](/media/kentcdodds.com/content/blog/how-to-use-react-context-effectively/auto-complete.png?tr=f_auto,q_auto,dpr_2.0,w_1600)

![type error on a misspelled dispatch type](/media/kentcdodds.com/content/blog/how-to-use-react-context-effectively/type-error.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
[my Advanced React Patterns workshop](https://epicreact.dev/patterns):
...
[add yourself to the waitlist](https://epicreact.dev/patterns) for the next time
I host the workshop)!
