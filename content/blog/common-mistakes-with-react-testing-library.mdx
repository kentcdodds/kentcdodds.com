...
<callout-warning class="asside">Importance: medium</callout-warning>
...
<callout-info class="asside">Importance: low</callout-info>
...
<callout-danger class="asside">Importance: high</callout-danger>
...
<callout-success>
  Advice: Only use the `query*` variants for asserting that an element cannot
  found.
</callout-success>
...
<callout-success>
  Advice: use `find*` any time you want to query for something that may not
