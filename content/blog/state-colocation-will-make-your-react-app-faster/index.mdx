...
![where to put react state](/media/kentcdodds.com/content/blog/state-colocation-will-make-your-react-app-faster/where-to-put-state.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
