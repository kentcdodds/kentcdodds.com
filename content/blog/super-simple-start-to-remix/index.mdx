...
![Browser window with the text "This is a remix app. Hooray!"" And a button with the number 0 in it](/media/image/upload/v1620151304/kentcdodds.com/blog/super-simple-start-to-remix/app_ol57hw.png)
...
![Network tab showing two GET requests, one for the document and the other for a favicon](/media/image/upload/v1620395539/kentcdodds.com/blog/super-simple-start-to-remix/network-tab_iyg7iy.png)
...
<img
	...
	alt="CD"
	src="/media/image/upload/w_120,q_auto,dpr_2.0/v1620153603/kentcdodds.com/blog/super-simple-start-to-remix/favicon_vsvcsr.ico"
/>
...
![Network tab with scripts getting loaded](/media/image/upload/v1620153551/kentcdodds.com/blog/super-simple-start-to-remix/network-tab-with-scripts_tdibpc.png)
...
![The working app](/media/image/upload/v1620155777/kentcdodds.com/blog/super-simple-start-to-remix/app-running-in-production_hnbdvy.png)
