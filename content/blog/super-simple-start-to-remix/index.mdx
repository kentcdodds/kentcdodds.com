...
![Browser window with the text "This is a remix app. Hooray!"" And a button with the number 0 in it](/media/blog/super-simple-start-to-remix/app_ol57hw.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
![Network tab showing two GET requests, one for the document and the other for a favicon](/media/blog/super-simple-start-to-remix/network-tab_iyg7iy.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
<img
	...
	alt="CD"
	src="/media/blog/super-simple-start-to-remix/favicon_vsvcsr.ico?tr=w_120,q_auto,dpr_2.0"
/>
...
![Network tab with scripts getting loaded](/media/blog/super-simple-start-to-remix/network-tab-with-scripts_tdibpc.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
![The working app](/media/blog/super-simple-start-to-remix/app-running-in-production_hnbdvy.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
