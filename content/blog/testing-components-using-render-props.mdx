c--- title: Testing ⚛️ components using render props date: 2018-01-08
description: Let's look at how we can write tests for React components that use
render props! meta: keywords: - javascript - testing - react bannerCloudinaryId:
unsplash/photo-1500479694472-551d1fb6258d bannerCredit: Photo by
[Scott Walsh](https://unsplash.com/photos/CQl3Y5bV6FA)
