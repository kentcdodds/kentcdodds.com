c--- title: Please stop building inaccessible forms (and how to fix them) date:
2019-02-04 description: I regularly find inaccessible forms. In this post we'll
check out some common accessibility problems and fix them. meta: keywords: -
Accessibility - Forms bannerCloudinaryId:
unsplash/photo-1493119508027-2b584f234d6c bannerCredit: Photo by
[Goran Ivos](https://unsplash.com/photos/iacpoKgpBAM)
