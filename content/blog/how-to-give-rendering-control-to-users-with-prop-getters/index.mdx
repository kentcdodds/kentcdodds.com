...
meta:
  keywords:
    - javascript
    - react
bannerImageId: unsplash/photo-1464348123218-0ee63dfd2746
...
![dog wagging the tail while waiting](/media/kentcdodds.com/content/blog/how-to-give-rendering-control-to-users-with-prop-getters/0.gif?tr=f_auto,q_auto,w_1600)
...
![React toggled logo](/media/kentcdodds.com/content/blog/how-to-give-rendering-control-to-users-with-prop-getters/1.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
