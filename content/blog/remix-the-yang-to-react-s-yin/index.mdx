...
<Themed
	dark={
		<a
			href="/media/image/upload/v2/kentcdodds.com/content/blog/remix-the-yang-to-react-s-yin/network-chasm-dark"
			target="_blank"
		>
			<BlogImage
	...
	light={
		<a
			href="/media/image/upload/v2/kentcdodds.com/content/blog/remix-the-yang-to-react-s-yin/network-chasm-light"
			target="_blank"
		>
			<BlogImage
...
<Themed
	dark={
		<a
			href="/media/image/upload/kentcdodds.com/content/blog/remix-the-yang-to-react-s-yin/client-side-apps-only-dark"
			target="_blank"
		>
			<BlogImage
	...
	light={
		<a
			href="/media/image/upload/kentcdodds.com/content/blog/remix-the-yang-to-react-s-yin/client-side-apps-only-light"
			target="_blank"
		>
			<BlogImage
...
<Themed
	dark={
		<a
			href="/media/image/upload/kentcdodds.com/content/blog/remix-the-yang-to-react-s-yin/remixed-router-apps-dark"
			target="_blank"
		>
			<BlogImage
	...
	light={
		<a
			href="/media/image/upload/kentcdodds.com/content/blog/remix-the-yang-to-react-s-yin/remixed-router-apps-light"
			target="_blank"
		>
			<BlogImage
...
<Themed
	dark={
		<a
			href="/media/image/upload/kentcdodds.com/content/blog/remix-the-yang-to-react-s-yin/backend-for-frontend-dark"
			target="_blank"
		>
			<BlogImage
	...
	light={
		<a
			href="/media/image/upload/kentcdodds.com/content/blog/remix-the-yang-to-react-s-yin/backend-for-frontend-light"
			target="_blank"
		>
			<BlogImage
...
<Themed
	dark={
		<a
			href="/media/image/upload/kentcdodds.com/content/blog/remix-the-yang-to-react-s-yin/full-stack-dark"
			target="_blank"
		>
			<BlogImage
	...
	light={
		<a
			href="/media/image/upload/kentcdodds.com/content/blog/remix-the-yang-to-react-s-yin/full-stack-light"
			target="_blank"
		>
			<BlogImage
