...
meta:
  keywords:
    ...
    - Code
    - Clean Code
bannerImageId: unsplash/photo-1444703686981-a3abbc4d4fe3
...
translations:
  ...
  - language: Español
    link: https://www.redradix.com/insights/colocalizacion
    author:
  ...
  - language: Português
    link: https://mateusf.com/blog/post/co-localizacao
    author:
      name: Mateus Felipe Gonçalves
      link: https://mateusf.com/about
---
...
[not](https://x.com/ryanflorence/status/747983065738153985)).
...
reasonable." ([Dan Abramov](https://x.com/dan_abramov) said something like
this to me once).
...
[Pete Hunt](https://x.com/floydophone) and re-evaluate what that means 😀.
