...
[kentcdodds.com](https://kentcdodds.com) is completely custom built by me using
[Remix](https://remix.run). After writing tens of thousands of lines of code
using this framework, I have developed a great appreciation for what this
framework can do for me and the users of my site. I want to tell you about some
of it.
...
[indirectly impacted](/blog/why-users-care-about-how-you-write-code) by our the
maintainability of our code.

Remix helps with many of these things. Some without me having to think about it.
In particulare, some of the harder problems involving state management (race
...
hyrdated. This means that the user can start getting work done with the app,
...
And also (unique to Remix), this works on the server as well, so users will get
the same experience whether the error happened during a client transition or a
