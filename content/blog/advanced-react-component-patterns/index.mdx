...
meta:
  keywords:
    - javascript
    - react
bannerImageId: unsplash/photo-1504006833117-8886a355efbf
...
![awesome!](/media/image/upload/v1625030270/kentcdodds.com/content/blog/advanced-react-component-patterns/images/0.gif)
...
![I am blown away!](/media/image/upload/v1625030269/kentcdodds.com/content/blog/advanced-react-component-patterns/images/1.gif)
...
![glowing seapig](/media/image/upload/v1625030267/kentcdodds.com/content/blog/advanced-react-component-patterns/images/2.gif)

### Higher Order Components

Higher Order Components (HOC) are functions which return a component (fun fact,
[the name "Higher Order Component"](https://x.com/kentcdodds/status/930832776907046912)
is a bit of
[a misnomer](https://x.com/kentcdodds/status/930844136617533441)). This
...
![use a render prop](/media/image/upload/v1625030269/kentcdodds.com/content/blog/advanced-react-component-patterns/images/3.gif)
...
![I can hardly wait](/media/image/upload/v1625030268/kentcdodds.com/content/blog/advanced-react-component-patterns/images/4.gif)
