...
<callout-info>
  Play around with the above macro example
  [on astexplorer.net](https://astexplorer.net/#/gist/e586bcbbf2ce35835115a7d808528c90/b64f5f025d98481ebfb93a582334c8562f7337f0).
  See if you can make it support an import called `lineColumn` that is
  replaced with the sum of line and column. Just for fun!
</callout-info>