...
![gif of the rendered component showing an input and toggle that sync their state](/media/blog/control-props-vs-state-reducers/toggle1.gif?tr=f_auto,q_auto,w_1600)
...
![gif of the rendered component showing a toggle, reset button, and counter that's limited to 4 toggles.](/media/blog/control-props-vs-state-reducers/toggle2.gif?tr=f_auto,q_auto,w_1600)
