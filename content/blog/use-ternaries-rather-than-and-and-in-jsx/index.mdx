...
![PayPal page with contacts](/media/image/upload/v1625033483/kentcdodds.com/content/blog/use-ternaries-rather-than-and-and-in-jsx/contacts.png)

When a user came with no contacts, this is what they saw:

![PayPal page with 0 instead of contacts](/media/image/upload/v1625033483/kentcdodds.com/content/blog/use-ternaries-rather-than-and-and-in-jsx/no-contacts.png)
