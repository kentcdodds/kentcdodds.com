...
bannerImageId: unsplash/photo-1516824600626-47a22f894aff
...
![PayPal page with contacts](/media/kentcdodds.com/content/blog/use-ternaries-rather-than-and-and-in-jsx/contacts.png?tr=f_auto,q_auto,dpr_2.0,w_1600)

When a user came with no contacts, this is what they saw:

![PayPal page with 0 instead of contacts](/media/kentcdodds.com/content/blog/use-ternaries-rather-than-and-and-in-jsx/no-contacts.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
