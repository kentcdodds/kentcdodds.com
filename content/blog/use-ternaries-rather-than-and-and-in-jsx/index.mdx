...
![PayPal page with contacts](/media/blog/use-ternaries-rather-than-and-and-in-jsx/contacts.png?tr=f_auto,q_auto,dpr_2.0,w_1600)

When a user came with no contacts, this is what they saw:

![PayPal page with 0 instead of contacts](/media/blog/use-ternaries-rather-than-and-and-in-jsx/no-contacts.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
