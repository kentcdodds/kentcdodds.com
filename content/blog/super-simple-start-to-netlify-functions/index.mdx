...
![The above code in an editor](/media/blog/super-simple-start-to-netlify-functions/code.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
![The github repository](/media/blog/super-simple-start-to-netlify-functions/repo.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
![Create New Site page](/media/blog/super-simple-start-to-netlify-functions/create-new-site.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
![Overview page](/media/blog/super-simple-start-to-netlify-functions/overview.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
![Functions page showing hello.js](/media/blog/super-simple-start-to-netlify-functions/functions.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
![Function log page](/media/blog/super-simple-start-to-netlify-functions/function-log.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
![Function output saying Hello Bob Ross](/media/blog/super-simple-start-to-netlify-functions/function-output.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
