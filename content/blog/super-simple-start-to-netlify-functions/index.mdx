...
meta:
  keywords:
    ...
    - lambda
    - functions
bannerImageId: unsplash/photo-1529333034259-bc9d027df718
...
![The above code in an editor](/media/kentcdodds.com/content/blog/super-simple-start-to-netlify-functions/code.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
![The github repository](/media/kentcdodds.com/content/blog/super-simple-start-to-netlify-functions/repo.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
![Create New Site page](/media/kentcdodds.com/content/blog/super-simple-start-to-netlify-functions/create-new-site.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
![Overview page](/media/kentcdodds.com/content/blog/super-simple-start-to-netlify-functions/overview.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
![Functions page showing hello.js](/media/kentcdodds.com/content/blog/super-simple-start-to-netlify-functions/functions.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
![Function log page](/media/kentcdodds.com/content/blog/super-simple-start-to-netlify-functions/function-log.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
![Function output saying Hello Bob Ross](/media/kentcdodds.com/content/blog/super-simple-start-to-netlify-functions/function-output.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
