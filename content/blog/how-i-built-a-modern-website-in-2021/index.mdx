...
meta:
  keywords:
    ...
    - tailwind css
    - magic links
bannerImageId: kentcdodds.com/content/blog/how-i-built-a-modern-website-in-2021/banner_iplhop
...
<Themed
	dark={
		...
		>
			<BlogImage
				imageId="kentcdodds.com/content/blog/how-i-built-a-modern-website-in-2021/contributor-graph-dark"
	...
	light={
		...
		>
			<BlogImage
				imageId="kentcdodds.com/content/blog/how-i-built-a-modern-website-in-2021/contributor-graph-light"
				imgProps={{ alt: 'GitHub contributor graph' }}
			/>
		</a>
	}
...
<Themed
	dark={
		<a
			href="/media/kentcdodds.com/content/blog/how-i-built-a-modern-website-in-2021/deployment-pipeline-dark?tr=f_auto,q_auto,dpr_2.0,w_1600"
			target="_blank"
		>
			<BlogImage
				imageId="kentcdodds.com/content/blog/how-i-built-a-modern-website-in-2021/deployment-pipeline-dark"
	...
	light={
		<a
			href="/media/kentcdodds.com/content/blog/how-i-built-a-modern-website-in-2021/deployment-pipeline-light?tr=f_auto,q_auto,dpr_2.0,w_1600"
			target="_blank"
		>
			<BlogImage
				imageId="kentcdodds.com/content/blog/how-i-built-a-modern-website-in-2021/deployment-pipeline-light"
				imgProps={{ alt: 'Excalidraw diagram of a deployment pipeline' }}
			/>
		</a>
	}
...
<Themed
	dark={
		<a
			href="/media/kentcdodds.com/content/blog/how-i-built-a-modern-website-in-2021/database-connectivity-dark?tr=f_auto,q_auto,dpr_2.0,w_1600"
			target="_blank"
		>
			<BlogImage
				imageId="kentcdodds.com/content/blog/how-i-built-a-modern-website-in-2021/database-connectivity-dark"
				imgProps={{
	...
	light={
		<a
			href="/media/kentcdodds.com/content/blog/how-i-built-a-modern-website-in-2021/database-connectivity-light?tr=f_auto,q_auto,dpr_2.0,w_1600"
			target="_blank"
		>
			<BlogImage
				imageId="kentcdodds.com/content/blog/how-i-built-a-modern-website-in-2021/database-connectivity-light"
				imgProps={{
					alt: 'Excalidraw diagram of a databases in different regions',
				}}
			/>
...
<Themed
	dark={
		<a
			href="/media/kentcdodds.com/content/blog/how-i-built-a-modern-website-in-2021/fly-request-replays-dark?tr=f_auto,q_auto,dpr_2.0,w_1600"
			target="_blank"
		>
			<BlogImage
				imageId="kentcdodds.com/content/blog/how-i-built-a-modern-website-in-2021/fly-request-replays-dark"
				imgProps={{
	...
	light={
		<a
			href="/media/kentcdodds.com/content/blog/how-i-built-a-modern-website-in-2021/fly-request-replays-light?tr=f_auto,q_auto,dpr_2.0,w_1600"
			target="_blank"
		>
			<BlogImage
				imageId="kentcdodds.com/content/blog/how-i-built-a-modern-website-in-2021/fly-request-replays-light"
				imgProps={{
					alt: 'Excalidraw diagram of a user POST request made to different regions being routed to the primary region',
				}}
			/>
...
<Themed
	dark={
		<a
			href="/media/kentcdodds.com/content/blog/how-i-built-a-modern-website-in-2021/auth-flow-dark?tr=f_auto,q_auto,dpr_2.0,w_1600"
			target="_blank"
		>
			<BlogImage
				imageId="kentcdodds.com/content/blog/how-i-built-a-modern-website-in-2021/auth-flow-dark"
				imgProps={{
	...
	light={
		<a
			href="/media/kentcdodds.com/content/blog/how-i-built-a-modern-website-in-2021/auth-flow-light?tr=f_auto,q_auto,dpr_2.0,w_1600"
			target="_blank"
		>
			<BlogImage
				imageId="kentcdodds.com/content/blog/how-i-built-a-modern-website-in-2021/auth-flow-light"
				imgProps={{
					alt: 'Excalidraw diagram of a user going to the login screen, clicking the magic link, and getting authenticated',
				}}
			/>
...
<Themed
	dark={
		<a
			href="/media/kentcdodds.com/content/blog/how-i-built-a-modern-website-in-2021/session-flow-dark?tr=f_auto,q_auto,dpr_2.0,w_1600"
			target="_blank"
		>
			<BlogImage
				imageId="kentcdodds.com/content/blog/how-i-built-a-modern-website-in-2021/session-flow-dark"
				imgProps={{
	...
	light={
		<a
			href="/media/kentcdodds.com/content/blog/how-i-built-a-modern-website-in-2021/session-flow-light?tr=f_auto,q_auto,dpr_2.0,w_1600"
			target="_blank"
		>
			<BlogImage
				imageId="kentcdodds.com/content/blog/how-i-built-a-modern-website-in-2021/session-flow-light"
				imgProps={{
					alt: 'Excalidraw diagram of a user going to an authenticated page and the session being resolved to a user or the user getting redirected to login',
				}}
			/>
...
![Remix logo](/media/kentcdodds.com/content/blog/how-i-built-a-modern-website-in-2021/remix?tr=f_auto,q_auto,dpr_2.0,w_1600)
