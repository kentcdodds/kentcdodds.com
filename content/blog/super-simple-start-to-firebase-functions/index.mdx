...
![Firebase console showing an "Add project" button](/media/blog/super-simple-start-to-firebase-functions/step-1-firebase-console.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
![Let's start with a name for your project. Project name: My Awesome Firebase Thing. my-awesome-firebase-thin-33d3a. A unique identifier for your project](/media/blog/super-simple-start-to-firebase-functions/step-1-2-firebase-name.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
![Firebase console showing the setting page with the Project ID](/media/blog/super-simple-start-to-firebase-functions/step-3-project-id.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
![Terminal output from the firebase login command](/media/blog/super-simple-start-to-firebase-functions/step-8-login.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
![Emulator overview](/media/blog/super-simple-start-to-firebase-functions/step-9-emulator-overview.png?tr=f_auto,q_auto,dpr_2.0,w_1600)

If you hit your serverless function in a browser you should see the output:

![Browser saying "Hello World!"](/media/blog/super-simple-start-to-firebase-functions/step-9-fn-output.png?tr=f_auto,q_auto,dpr_2.0,w_1600)

And then your logs will show that the function was run:

![Function logs](/media/blog/super-simple-start-to-firebase-functions/step-9-fn-logs.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
![Usage and billing settings page](/media/blog/super-simple-start-to-firebase-functions/step-11-usage-and-billing.png?tr=f_auto,q_auto,dpr_2.0,w_1600)

Then you'll click "Modify plan" and then "Select plan" under "Blaze Pay as you
go":

![Firebase billing plans](/media/blog/super-simple-start-to-firebase-functions/step-11-firebase-billing-plans.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
![Browser saying "Hello Bob Ross!"](/media/blog/super-simple-start-to-firebase-functions/step-12-deployed-fn-output.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
![GitHub secrets UI adding the firebase token](/media/blog/super-simple-start-to-firebase-functions/step-14-add-secret.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
...
![Action output showing the deploy](/media/blog/super-simple-start-to-firebase-functions/step-16-action-output.png?tr=f_auto,q_auto,dpr_2.0,w_1600)
