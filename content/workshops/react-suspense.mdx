...
<ul>
  <li>know how Suspense works fundamentally</li>
  <li>be able to write your own Suspense-based abstraction</li>
  <li>understand the benefits and how to of "render as you fetch"</li>
  <li>
    know how to use <code>useTransition</code> and <code>useDeferredValue</code>{' '}
    effectively
  </li>
  <li>know how to write your own cache for suspense-based abstractions</li>
  <li>
