...
meta:
  ...
  description:
    ...
    fundamental building block of React applications. When you’re finished,
    you’ll go back to your applications and refactor your components to be
    simpler, more flexible, and easier to maintain because of what you’ve
    learned.'
  keywords:
    - react
    - react hooks
...
<ul>
  <li>remove tons of code: you just won't need it anymore</li>
  <li>
    simplify state management: guess what, you probably don't need a library
    like Redux anymore
  </li>
  <li>understand your application better</li>
</ul>
...
<ul>
  <li>manage state like a pro with useState.</li>
  <li>Interact with the DOM useRef and useEffect</li>
  <li>make HTTP requests like a boss 😎 with useEffect</li>
  <li>Create custom hooks to organize and reuse component logic</li>
</ul>
