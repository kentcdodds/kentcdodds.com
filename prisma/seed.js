...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var kent, hannah, kody, peter, postReads, _i, _a, _b, user, reads, index;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 5:
                    ...
                    postReads = [
                        prisma.postRead.create({
                            data: {
                                ...
                                userId: peter.id,
                                createdAt: (0, date_fns_1.subMonths)(new Date(), 13),
                            },
                        }),
                    ];
                    for (_i = 0, _a = [
                    ...
                    return [4 /*yield*/, Promise.all(postReads)];
                case 6:
                    _c.sent();
                    console.log('created');
                    return [2 /*return*/];
