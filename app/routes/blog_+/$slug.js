    ...
    return (<grid_tsx_1.Grid>
			<div className="col-span-full mb-12 flex flex-col flex-wrap justify-between gap-2 border-b border-gray-600 pb-12 text-lg font-medium text-slate-500 lg:col-span-8 lg:col-start-3 lg:flex-row lg:pb-6">
				<div className="flex space-x-5">
					<a className={(0, clsx_1.clsx)('underlined text-black hover:text-black focus:text-black focus:outline-none dark:hover:text-white dark:focus:text-white', { hidden: isDraft })} target="_blank" rel="noreferrer noopener" href={"https://x.com/intent/tweet?".concat(new URLSearchParams({
            url: permalink,
            text: tweetMessage,
        }))}>
						Post this article
				...
				<div className="flex">
					<a className={(0, clsx_1.clsx)('underlined text-black hover:text-black focus:text-black focus:outline-none dark:hover:text-white dark:focus:text-white', { hidden: isDraft })} target="_blank" rel="noreferrer noopener" href={"https://x.com/search?".concat(new URLSearchParams({
            q: permalink,
        }))}>
						Discuss on 𝕏
					</a>
					...
					<a className="underlined text-black hover:text-black focus:text-black focus:outline-none dark:hover:text-white dark:focus:text-white" target="_blank" rel="noreferrer noopener" href={editLink}>
						Edit on GitHub
					</a>
				</div>
			</div>
...
function MdxScreen() {
    ...
    return (<div key={slug} className={data.leadingTeam
            ...
            categoriesAndKeywords.includes('ai') ? (<div className="mx-auto mb-24 flex max-w-lg flex-col items-center justify-center gap-8 px-10vw md:max-w-none md:flex-row">
					...
					{categoriesAndKeywords.includes('remix') ? (<div className="w-full max-w-lg @container">
							<course_card_tsx_1.CourseCard title="Epic Web" description="Become a full stack web dev." label="Full stack course" lightImageBuilder={images_tsx_1.images.courseEpicWebLight} darkImageBuilder={images_tsx_1.images.courseEpicWebDark} courseUrl="https://www.epicweb.dev"/>
						</div>) : null}
					{categoriesAndKeywords.includes('ai') ||
                categoriesAndKeywords.includes('mcp') ? (<div className="w-full max-w-lg @container">
							<course_card_tsx_1.CourseCard title="Epic AI" description="Learn to build AI-powered applications." label="AI development course" lightImageBuilder={images_tsx_1.images.courseEpicAILight} darkImageBuilder={images_tsx_1.images.courseEpicAIDark} courseUrl="https://www.epicai.pro"/>
						</div>) : null}
				</div>) : null}
