...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var config, options, cookieHeader;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    options = _c.sent();
                    return [4 /*yield*/, webauthn_server_ts_1.passkeyCookie.serialize({
                            challenge: options.challenge,
                        })];
                case 2:
                    cookieHeader = _c.sent();
                    return [2 /*return*/, (0, node_1.json)({ options: options }, { headers: { 'Set-Cookie': cookieHeader } })];
            }
        });
    });
}
