...
function loader() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, (0, server_runtime_1.redirect)('/')];
        });
    });
}
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var formData, submission, theme, responseInit;
            ...
            switch (_c.label) {
                ...
                case 1:
                    ...
                    submission = (0, zod_1.parseWithZod)(formData, {
                        schema: theme_tsx_1.ThemeFormSchema,
                    });
                    if (submission.status !== 'success') {
                        return [2 /*return*/, (0, server_runtime_1.json)({ result: submission.reply() }, { status: submission.status === 'error' ? 400 : 200 })];
                    }
                    theme = submission.value.theme;
                    responseInit = {
                        headers: { 'set-cookie': (0, theme_server_ts_1.setTheme)(theme) },
                    };
                    return [2 /*return*/, (0, server_runtime_1.json)({ success: true, submission: submission }, responseInit)];
            }
        });
    });
}
