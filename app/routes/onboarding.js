					...
					<div className="col-span-full lg:col-span-8">
						...
						<react_1.Form method="POST">
							<div className="mb-6">
								...
								<form_elements_tsx_1.Input id="email" name="email" type="email" value={email} onChange={function (e) { return setEmail(e.target.value); }} placeholder="Enter your email address" autoComplete="email" autoFocus required/>
								{(actionData === null || actionData === void 0 ? void 0 : actionData.error) ? (<form_elements_tsx_1.InputError>{actionData.error}</form_elements_tsx_1.InputError>) : null}
								{(actionData === null || actionData === void 0 ? void 0 : actionData.success) ? (<div className="mt-2 text-green-600">{actionData.success}</div>) : null}
							</div>
