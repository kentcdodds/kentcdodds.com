    ...
    return __awaiter(this, arguments, void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    user = _c.sent();
                    return [4 /*yield*/, (0, prisma_server_ts_1.getAllUserData)(user.id)];
                case 2:
                    sqlite = _c.sent();
                    return [4 /*yield*/, (0, user_info_server_ts_1.getUserInfo)(user, { request: request })];
                case 3:
                    cache = _c.sent();
                    return [2 /*return*/, (0, node_1.json)({ sqlite: sqlite, cache: cache })];
            }
        });
    });
}
