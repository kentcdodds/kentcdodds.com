...
var verifier_server_1 = require("#app/utils/verifier.server");
function loader(_a) {
        ...
        return __generator(this, function (_t) {
            switch (_t.label) {
                ...
                case 6:
                    ...
                    return [4 /*yield*/, (0, verifier_server_1.isEmailVerified)(emailAddress)];
                case 7:
                ...
                case 11:
                    ...
                    domainUrl = (0, misc_1.getDomainUrl)(request);
                    return [4 /*yield*/, (0, session_server_1.sendToken)({ emailAddress: emailAddress, domainUrl: domainUrl })];
                case 12:
                    magicLink = _t.sent();
                ...
                case 14:
                    e_1 = _t.sent();
                    loginSession.flashError((0, misc_1.getErrorMessage)(e_1));
                    _l = node_1.redirect;
                    _m = ["/login"];
                    _s = {
                        status: 400
...
function Login() {
    ...
    return (<>
			<hero_section_1.HeroSection imageBuilder={images_1.images.skis} imageSize="medium" title="Log in to your account." subtitle="Or sign up for an account." action={<main>
						<div className="mb-8">
                ...
                setFormValues({ email: form.email.value });
									...
									<div className="mb-6">
										...
										<form_elements_1.Input ref={inputRef} autoFocus aria-describedby={data.error ? 'error-message' : 'success-message'} id="email-address" name="email" type="email" autoComplete="email" defaultValue={formValues.email} required placeholder="Email address"/>
									</div>
									...
									<div className="flex flex-wrap gap-4">
										<button_1.Button type="submit">Email a login link</button_1.Button>
                ...
                : 'Sign in form is now invalid.'}
									...
									<div className="mt-2">
										{data.error ? (<form_elements_1.InputError id="error-message">{data.error}</form_elements_1.InputError>) : data.email ? (<p id="success-message" className="text-lg text-gray-500 dark:text-slate-500">
