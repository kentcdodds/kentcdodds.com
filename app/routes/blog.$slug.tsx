    ...
    <Grid>
      ...
      <div className="lg:col-start:5 col-span-full lg:col-span-6">
        ...
        <Paragraph className="mb-12 mt-3">
          {`
Kent C. Dodds is a JavaScript software engineer and teacher. He's Co-Founder and
Director of Developer Experience at Remix! Kent's taught hundreds of thousands of
people how to make the world a better place with quality software development tools
and practices. He lives with his wife and four kids in Utah.
          `.trim()}
        </Paragraph>
