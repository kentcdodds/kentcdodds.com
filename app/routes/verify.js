					...
					<div className="col-span-full lg:col-span-6">
						<react_1.Form method="POST">
							...
							<div className="mb-6">
								...
								<form_elements_tsx_1.Input id="code" name="code" value={code} onChange={function (e) { return setCode(e.target.value); }} placeholder="Enter 6-digit code" autoComplete="one-time-code" autoFocus required/>
