            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, seasons.map(function (season) {
                            return {
                                route: "/chats/".concat(season.seasonNumber.toString().padStart(2, '0')),
                                priority: 0.4,
                            };
                        })];
            }
...
function loader(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var timings, seasons, seasonNumber, season;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    timings = {};
                    return [4 /*yield*/, (0, simplecast_server_ts_1.getSeasonListItems)({ request: request, timings: timings })];
                case 1:
                    seasons = _c.sent();
...
function ChatsSeason() {
    var season = (0, react_1.useLoaderData)().season;
    var sortOrder = (0, providers_tsx_1.useChatsEpisodeUIState)().sortOrder;
    var episodes = (0, lodash_ts_1.orderBy)(season.episodes, 'episodeNumber', sortOrder);
    return episodes.map(function (episode) { return (<react_1.Link className="group focus:outline-none" key={episode.slug} to={(0, chats_with_kent_ts_1.getCWKEpisodePath)(episode)}>
			<grid_tsx_1.Grid nested className="relative border-b border-gray-200 py-10 dark:border-gray-600 lg:py-5">
				...
				<div className="relative col-span-1 flex-none">
					...
					<img className="h-16 w-full rounded-lg object-cover" src={episode.image} alt={episode.title} loading="lazy"/>
				</div>
