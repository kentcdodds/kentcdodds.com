            ...
            setFormValues({
                ...
                confirmPassword: form.confirmPassword.value,
							...
							<div className="mb-6">
								...
								<form_elements_tsx_1.Input ref={passwordRef} id="password" name="password" type="password" autoComplete="new-password" placeholder="Enter new password" autoFocus required/>
								{passwordError && formValues.password ? (<form_elements_tsx_1.InputError id="password-error">{passwordError}</form_elements_tsx_1.InputError>) : null}
							</div>

							<div className="mb-6">
								<form_elements_tsx_1.Label htmlFor="confirmPassword">Confirm Password</form_elements_tsx_1.Label>
								<form_elements_tsx_1.Input ref={confirmPasswordRef} id="confirmPassword" name="confirmPassword" type="password" autoComplete="new-password" placeholder="Confirm new password" required/>
								{confirmPasswordError ? (<form_elements_tsx_1.InputError id="confirm-password-error">{confirmPasswordError}</form_elements_tsx_1.InputError>) : null}
							</div>

							{(actionData === null || actionData === void 0 ? void 0 : actionData.error) ? (<div className="mb-6">
									<form_elements_tsx_1.InputError id="form-error">{actionData.error}</form_elements_tsx_1.InputError>
								</div>) : null}
