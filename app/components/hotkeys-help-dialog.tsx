			...
			>
				<div className="flex items-start justify-between gap-6">
					...
					<button
						...
						className="text-secondary hover:text-primary focus:bg-blue-100 dark:focus:bg-blue-600 focus:outline-none focus:ring-4 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-gray-900 focus-visible:bg-blue-100 dark:focus-visible:bg-blue-600 focus-visible:ring-4 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-gray-900 inline-flex h-10 w-10 shrink-0 cursor-pointer items-center justify-center rounded-md p-1 transition"
					>
						<CloseIcon size={18} />
					</button>
				</div>
