...
exports.XIcon = XIcon;
exports.PocketCastsIcon = PocketCastsIcon;
...
function AppleIcon() {
    return (<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path fillRule="evenodd" clipRule="evenodd" d="M14.859 6.15322C15.474 5.36022 15.94 4.23822 15.771 3.09222C14.766 3.16222 13.591 3.80522 12.907 4.64322C12.282 5.40322 11.768 6.53222 11.968 7.63022C13.067 7.66422 14.202 7.00522 14.859 6.15322Z" fill="currentColor"/>
			<path fillRule="evenodd" clipRule="evenodd" d="M19.7438 9.41843C18.7788 8.20843 17.4228 7.50543 16.1408 7.50543C14.4498 7.50543 13.7348 8.31543 12.5598 8.31543C11.3478 8.31543 10.4288 7.50843 8.9658 7.50843C7.5288 7.50843 5.9998 8.38643 5.0298 9.88743C3.6668 12.0014 3.8998 15.9764 6.1088 19.3614C6.8998 20.5734 7.9558 21.9354 9.3368 21.9474C10.5658 21.9594 10.9128 21.1594 12.5778 21.1504C14.2428 21.1414 14.5578 21.9584 15.7858 21.9454C17.1678 21.9344 18.2808 20.4244 19.0718 19.2134C19.6388 18.3454 19.8488 17.9074 20.2898 16.9274C17.0928 15.7104 16.5798 11.1634 19.7438 9.41843Z" fill="currentColor"/>
		</svg>);
}
var arrowRotationMap = {
    up: 'rotate-180',
    right: '-rotate-90',
    down: 'rotate-0',
    left: 'rotate-90',
...
function ArrowIcon(_a) {
    var direction = _a.direction, _b = _a.size, size = _b === void 0 ? 32 : _b, className = _a.className;
    return (<svg className={(0, clsx_1.clsx)(className, 'transform', arrowRotationMap[direction])} width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path fillRule="evenodd" clipRule="evenodd" d="M15.101 5.5V23.1094L9.40108 17.4095L8.14807 18.6619L15.9862 26.5L23.852 18.6342L22.5996 17.3817L16.8725 23.1094V5.5H15.101Z" fill="currentColor"/>
		</svg>);
}
function AwardIcon(_a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.size, size = _c === void 0 ? 24 : _c;
    return (<svg width={size} height={size} fill="none" viewBox="0 0 24 24">
			<path d="M17.25 10a5.25 5.25 0 11-10.5 0 5.25 5.25 0 0110.5 0z" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"/>
			<path d="M8.75 14.75l-1 4.5 4.25-1.5 4.25 1.5-1-4.5" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"/>
		</svg>);
}
function BadgeIcon(_a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.size, size = _c === void 0 ? 24 : _c;
    return (<svg width={size} height={size} fill="none" viewBox="0 0 24 24">
			<path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M14.25 8.75l4-4H5.75l4 4"/>
			<circle cx={12} cy={14} r={5.25} stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}/>
		</svg>);
}
function BehanceIcon(_a) {
    var _b = _a.size, size = _b === void 0 ? 24 : _b, _c = _a.title, title = _c === void 0 ? 'Behance' : _c;
...
function BriefcaseIcon(_a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.size, size = _c === void 0 ? 24 : _c;
    return (<svg width={size} height={size} fill="none" viewBox="0 0 24 24">
			<path d="M4.75 9.75a2 2 0 012-2h10.5a2 2 0 012 2v7.5a2 2 0 01-2 2H6.75a2 2 0 01-2-2v-7.5z" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"/>
			<path d="M8.75 18.75v-12a2 2 0 012-2h2.5a2 2 0 012 2v12" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"/>
		</svg>);
}
function CheckCircledIcon(_a) {
    var _b = _a.size, size = _b === void 0 ? 36 : _b, className = _a.className;
    return (<svg width={size} height={size} viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
			<circle cx="18" cy="18" r="18" fill="currentColor"/>
			<path d="M10.8115 17L16.4214 22.6099L25.0314 14" stroke="white" strokeWidth="2"/>
		</svg>);
}
function CheckIcon() {
...
function ChevronDownIcon(_a) {
    ...
    return (<svg width="24" height="24" fill="none" viewBox="0 0 24 24" className={className}>
...
function DiscordLogo() {
    return (<svg height="48" viewBox="0 0 292 80" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function DribbbleIcon(_a) {
    var _b = _a.size, size = _b === void 0 ? 24 : _b, _c = _a.title, title = _c === void 0 ? 'Dribbble' : _c;
    return (<svg width={size} height={size} fill="none" viewBox="0 0 24 24">
			<title>{title}</title>
			<path d="M19.25 12a7.25 7.25 0 11-14.5 0 7.25 7.25 0 0114.5 0zM8.271 6.5c2.787 1.6 6.678 4.66 8.879 10M16 6.39C14.357 8.374 10.69 11.71 5 11M10.688 19s.812-6.5 8.03-8.5" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"/>
		</svg>);
}
function EmojiHappyIcon(_a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.size, size = _c === void 0 ? 24 : _c;
    return (<svg width={size} height={size} fill="none" viewBox="0 0 24 24">
			<path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8.75 4.75h6.5a4 4 0 014 4v6.5a4 4 0 01-4 4h-6.5a4 4 0 01-4-4v-6.5a4 4 0 014-4z"/>
			<path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M7.75 12.75S9 15.25 12 15.25s4.25-2.5 4.25-2.5"/>
...
function FastForwardIcon(_a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.size, size = _c === void 0 ? 24 : _c;
    return (<svg width={size} height={size} fill="none" viewBox="0 0 24 24">
			<path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 15.86l-3.25 2.39V5.75L8 8.14M19.25 12l-8.5-6.25v12.5l8.5-6.25z"/>
		</svg>);
}
function GithubIcon(_a) {
    var _b = _a.size, size = _b === void 0 ? 24 : _b, _c = _a.title, title = _c === void 0 ? 'GitHub' : _c;
    return (<svg width={size} height={size} fill="none" viewBox="0 0 24 24">
			<title>{title}</title>
...
function GlobeIcon(_a) {
    var _b = _a.size, size = _b === void 0 ? 24 : _b, _c = _a.title, title = _c === void 0 ? 'Globe' : _c;
    return (<svg width={size} height={size} fill="none" viewBox="0 0 24 24">
			<title>{title}</title>
			<circle cx={12} cy={12} r={7.25} stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}/>
			<path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15.25 12c0 4.5-2.007 7.25-3.25 7.25-1.243 0-3.25-2.75-3.25-7.25S10.757 4.75 12 4.75c1.243 0 3.25 2.75 3.25 7.25zM5 12h14"/>
		</svg>);
}
function HeartIcon(_a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.size, size = _c === void 0 ? 24 : _c;
    return (<svg width={size} height={size} fill="none" viewBox="0 0 24 24">
			<path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M11.995 7.233c-1.45-1.623-3.867-2.06-5.683-.573-1.816 1.486-2.072 3.971-.645 5.73l6.328 5.86 6.329-5.86c1.426-1.759 1.201-4.26-.646-5.73-1.848-1.471-4.233-1.05-5.683.573z" clipRule="evenodd"/>
		</svg>);
}
function InstagramIcon(_a) {
    var _b = _a.size, size = _b === void 0 ? 24 : _b, _c = _a.title, title = _c === void 0 ? 'Instagram' : _c;
    return (<svg width={size} height={size} fill="none" viewBox="0 0 24 24">
			<title>{title}</title>
			<path d="M4.75 7.75a3 3 0 013-3h8.5a3 3 0 013 3v8.5a3 3 0 01-3 3h-8.5a3 3 0 01-3-3v-8.5z" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"/>
			<path d="M16.5 8a.5.5 0 11-1 0 .5.5 0 011 0z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
			<path d="M15.25 13a3.25 3.25 0 11-6.5 0 3.25 3.25 0 016.5 0z" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"/>
		</svg>);
}
function LaptopIcon(_a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.size, size = _c === void 0 ? 24 : _c;
    return (<svg width={size} height={size} fill="none" viewBox="0 0 24 24">
			<path d="M5.75 5.75a1 1 0 011-1h10.5a1 1 0 011 1v8.5H5.75v-8.5zM18.25 14.5l.746 3.544a1 1 0 01-.979 1.206H5.982a1 1 0 01-.978-1.206L5.75 14.5" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"/>
		</svg>);
}
function LinkedInIcon(_a) {
    var _b = _a.size, size = _b === void 0 ? 24 : _b, _c = _a.title, title = _c === void 0 ? 'LinkedIn' : _c;
    return (<svg width={size} height={size} fill="none" viewBox="0 0 24 24">
			<title>{title}</title>
			<path d="M4.75 7.75a3 3 0 013-3h8.5a3 3 0 013 3v8.5a3 3 0 01-3 3h-8.5a3 3 0 01-3-3v-8.5z" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"/>
			<path d="M10.75 16.25V14a2.25 2.25 0 014.5 0v2.25M10.75 11.75v4.5M7.75 11.75v4.5M7.75 8.75v.5" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"/>
		</svg>);
}
function LogoutIcon() {
    return (<svg width="24" height="24" fill="none" viewBox="0 0 24 24">
...
function MailIcon(_a) {
    var _b = _a.size, size = _b === void 0 ? 24 : _b;
    return (<svg width={size} height={size} fill="none" viewBox="0 0 24 24">
			<path d="M4.75 8.75L12 4.75L19.25 8.75V17.25C19.25 18.3546 18.3546 19.25 17.25 19.25H6.75C5.64543 19.25 4.75 18.3546 4.75 17.25V8.75Z" stroke="#141414" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
			<path d="M19 9L13.25 13.25H10.75L5 9" stroke="#141414" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
		</svg>);
}
function MenuIcon() {
...
function MessageIcon(_a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.size, size = _c === void 0 ? 24 : _c;
    return (<svg width={size} height={size} fill="none" viewBox="0 0 24 24">
			<path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 18.25c3.5 0 7.25-1.75 7.25-6.25S15.5 5.75 12 5.75 4.75 7.5 4.75 12c0 1.03.196 1.916.541 2.67.215.47.336.987.24 1.495l-.262 1.399a1 1 0 001.168 1.167l3.207-.602a2.24 2.24 0 01.764-.003c.527.084 1.062.124 1.592.124z"/>
			<path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" d="M9.5 12a.5.5 0 11-1 0 .5.5 0 011 0zM12.5 12a.5.5 0 11-1 0 .5.5 0 011 0zM15.5 12a.5.5 0 11-1 0 .5.5 0 011 0z"/>
		</svg>);
}
function MicrophoneIcon(_a) {
    var _b = _a.size, size = _b === void 0 ? 24 : _b;
    return (<svg width={size} height={size} fill="none" viewBox="0 0 24 24">
...
function MoonIcon() {
    return (<svg className="w-full" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path fillRule="evenodd" clipRule="evenodd" d="M14.228 7.9439C10.5176 8.82869 7.75757 12.1054 7.75757 15.9987C7.75757 20.5716 11.5618 24.2919 16.2367 24.2919C19.2323 24.2919 21.9337 22.7699 23.4514 20.3585C23.2779 20.3676 23.1033 20.3722 22.9287 20.3722C17.7826 20.3722 13.5951 16.2772 13.5951 11.2435C13.5951 10.1032 13.8108 8.98914 14.228 7.9439M16.2367 26.4993C10.3171 26.4993 5.50037 21.7899 5.50037 15.9987C5.50037 10.2109 10.3171 5.49927 16.2367 5.49927C16.6598 5.49927 17.0501 5.72963 17.2435 6.09753C17.438 6.46428 17.4087 6.90668 17.1638 7.24363C16.3059 8.42297 15.8535 9.80631 15.8535 11.2435C15.8535 15.06 19.0272 18.1637 22.9287 18.1637C23.6483 18.1637 24.3573 18.0582 25.0359 17.8531C25.4378 17.7293 25.8785 17.8359 26.1738 18.1304C26.4715 18.425 26.5758 18.8559 26.4446 19.2467C25.0019 23.5847 20.9 26.4993 16.2367 26.4993" fill="currentColor"/>
		</svg>);
}
function MugIcon(_a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.size, size = _c === void 0 ? 24 : _c;
    return (<svg width={size} height={size} fill="none" viewBox="0 0 24 24">
			<path d="M7.25 6.75h-.5a2 2 0 00-2 2v2.5a2 2 0 002 2h.5M19.25 4.75H7.75v9.5a2 2 0 002 2h7.5a2 2 0 002-2v-9.5zM19.25 19.25H4.75" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"/>
		</svg>);
}
function PartyIcon(_a) {
    var _b = _a.size, size = _b === void 0 ? 24 : _b;
    return (<svg width={size} height={size} fill="none" viewBox="0 0 24 24">
			<path d="m8.89 9.281-4.017 8.513c-.427.834.426 1.744 1.287 1.373l8.442-2.98" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"/>
			<path d="M13.32 10.977c1.64 1.893 2.378 4.108 1.65 4.949-.73.84-2.65-.011-4.29-1.903-1.64-1.893-2.378-4.108-1.65-4.949.73-.84 2.65.011 4.29 1.903ZM9.5 17.637c-.597-.382-1.227-.93-1.82-1.614-.39-.45-.73-.92-1.01-1.384" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"/>
			<path d="M11.5 5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
			<path d="m15.75 9.25.129-.129a3 3 0 0 0 0-4.242l-.129-.129M17 13l.293-.293a1 1 0 0 1 1.414 0L19 13" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"/>
		</svg>);
}
...
function PlayIcon() {
    return (<svg width="75" height="75" viewBox="0 0 75 75" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<path fillRule="evenodd" clipRule="evenodd" d="M35.2643 33.025L41.0017 36.9265C41.6519 37.369 41.6499 38.3118 40.9991 38.7518L35.2616 42.6276C34.5113 43.1349 33.4883 42.6077 33.4883 41.7143V33.9364C33.4883 33.0411 34.5146 32.5151 35.2643 33.025" fill="#030404"/>
		</svg>);
}
function PlusIcon() {
    return (<svg width="24" height="24" fill="none" viewBox="0 0 24 24">
...
function RocketIcon(_a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.size, size = _c === void 0 ? 24 : _c;
    return (<svg width={size} height={size} fill="none" viewBox="0 0 24 24">
			<path d="M13.456 6.855a8 8 0 015.408-2.105h.386v.386a8 8 0 01-2.105 5.408l-6.15 6.704-4.243-4.243 6.704-6.15zM7.25 16.75l-2.5 2.5M9.25 18.75l-.5.5M5.25 14.75l-.5.5M13 19.25L14.24 14 11 17.25l2 2zM6.75 13L10 9.75l-5.25 1 2 2.25z" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"/>
		</svg>);
}
function RssIcon(_a) {
    var _b = _a.size, size = _b === void 0 ? 24 : _b, _c = _a.title, title = _c === void 0 ? 'RSS' : _c, className = _a.className;
    return (<svg width={size} height={size} fill="none" viewBox="0 0 24 24" className={className}>
			<title>{title}</title>
			<path fillRule="evenodd" clipRule="evenodd" d="M7.33465 15.52C6.23018 15.52 5.33459 16.4153 5.33459 17.5199C5.33459 18.6244 6.23018 19.5201 7.33465 19.5201C8.43912 19.5201 9.33471 18.6244 9.33471 17.5199C9.33471 16.4153 8.43912 15.52 7.33465 15.52Z" fill="currentColor"/>
			<path fillRule="evenodd" clipRule="evenodd" d="M5.33472 10.52V13.0919C8.87972 13.0919 11.7639 15.9753 11.7639 19.5202H14.3347C14.3347 14.5577 10.2973 10.52 5.33472 10.52Z" fill="currentColor"/>
			<path fillRule="evenodd" clipRule="evenodd" d="M5.33472 5.52002V8.18702C11.5846 8.18702 16.6688 13.2701 16.6688 19.52H19.3347C19.3347 11.8001 13.0546 5.52002 5.33472 5.52002Z" fill="currentColor"/>
		</svg>);
}
function SearchIcon() {
    return (<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path fillRule="evenodd" clipRule="evenodd" d="M3.75068 11.3405C1.65161 9.23359 1.65161 5.80439 3.75068 3.69748C4.76756 2.67681 6.11976 2.11292 7.55689 2.11292C8.99619 2.11292 10.3484 2.67681 11.3653 3.69748C13.4622 5.80439 13.4622 9.23359 11.3653 11.3405C9.2662 13.4452 5.84975 13.4452 3.75068 11.3405ZM18 16.4548L13.595 12.0333C15.7986 9.06529 15.5874 4.8471 12.9047 2.15226C10.0479 -0.715235 5.06587 -0.719606 2.21121 2.15226C-0.737072 5.10937 -0.737072 9.9286 2.21121 12.8857C3.68536 14.3654 5.62112 15.1041 7.55906 15.1041C9.14861 15.1041 10.7229 14.5752 12.0555 13.5785L16.4605 18L18 16.4548Z" fill="currentColor"/>
		</svg>);
}
function SpinnerIcon(_a) {
    var _b = _a.size, size = _b === void 0 ? 24 : _b, svgProps = __rest(_a, ["size"]);
    return (<svg width={size} height={size} fill="none" viewBox="0 0 24 24" {...svgProps}>
...
function SunIcon() {
    return (<svg className="w-full" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path fillRule="evenodd" clipRule="evenodd" d="M16.0003 21.4194C13.0123 21.4194 10.5813 18.9874 10.5813 15.9994C10.5813 13.0114 13.0123 10.5804 16.0003 10.5804C18.9883 10.5804 21.4193 13.0114 21.4193 15.9994C21.4193 18.9874 18.9883 21.4194 16.0003 21.4194M16.0003 8.64136C11.9423 8.64136 8.64233 11.9414 8.64233 15.9994C8.64233 20.0574 11.9423 23.3574 16.0003 23.3574C20.0573 23.3574 23.3583 20.0574 23.3583 15.9994C23.3583 11.9414 20.0573 8.64136 16.0003 8.64136" fill="currentColor"/>
			<path fillRule="evenodd" clipRule="evenodd" d="M16.0004 7.08447C16.5364 7.08447 16.9704 6.64946 16.9704 6.11446V3.34546C16.9704 2.81046 16.5364 2.37646 16.0004 2.37646C15.4644 2.37646 15.0304 2.81046 15.0304 3.34546V6.11446C15.0304 6.64946 15.4644 7.08447 16.0004 7.08447" fill="currentColor"/>
			<path fillRule="evenodd" clipRule="evenodd" d="M6.11559 15.0298H3.34559C2.81059 15.0298 2.37659 15.4648 2.37659 15.9998C2.37659 16.5348 2.81059 16.9688 3.34559 16.9688H6.11559C6.65159 16.9688 7.08459 16.5348 7.08459 15.9998C7.08459 15.4648 6.65159 15.0298 6.11559 15.0298" fill="currentColor"/>
			<path fillRule="evenodd" clipRule="evenodd" d="M16.0004 24.9146C15.4644 24.9146 15.0304 25.3496 15.0304 25.8846V28.6536C15.0304 29.1886 15.4644 29.6236 16.0004 29.6236C16.5364 29.6236 16.9704 29.1886 16.9704 28.6536V25.8846C16.9704 25.3496 16.5364 24.9146 16.0004 24.9146" fill="currentColor"/>
			<path fillRule="evenodd" clipRule="evenodd" d="M28.6542 15.0298H25.8842C25.3492 15.0298 24.9152 15.4648 24.9152 15.9998C24.9152 16.5348 25.3492 16.9688 25.8842 16.9688H28.6542C29.1902 16.9688 29.6242 16.5348 29.6242 15.9998C29.6242 15.4648 29.1902 15.0298 28.6542 15.0298" fill="currentColor"/>
			<path fillRule="evenodd" clipRule="evenodd" d="M22.9896 9.97995C23.2376 9.97995 23.4856 9.88495 23.6756 9.69595L24.7036 8.66795C25.0816 8.28995 25.0816 7.67495 24.7036 7.29595C24.3246 6.91795 23.7106 6.91795 23.3316 7.29595L22.3036 8.32495C21.9256 8.70295 21.9256 9.31695 22.3036 9.69595C22.4926 9.88495 22.7416 9.97995 22.9896 9.97995" fill="currentColor"/>
			...
			<path fillRule="evenodd" clipRule="evenodd" d="M8.32507 22.3043L7.29707 23.3313C6.91807 23.7093 6.91807 24.3243 7.29707 24.7023C7.48607 24.8923 7.73407 24.9873 7.98207 24.9873C8.23007 24.9873 8.47807 24.8923 8.66807 24.7023L9.69607 23.6753C10.0751 23.2973 10.0751 22.6833 9.69607 22.3043C9.31807 21.9253 8.70307 21.9253 8.32507 22.3043" fill="currentColor"/>
			<path fillRule="evenodd" clipRule="evenodd" d="M23.6752 22.3043C23.2962 21.9253 22.6822 21.9253 22.3032 22.3043C21.9252 22.6833 21.9252 23.2973 22.3042 23.6753L23.3322 24.7023C23.5212 24.8923 23.7692 24.9873 24.0182 24.9873C24.2662 24.9873 24.5142 24.8923 24.7032 24.7023C25.0822 24.3243 25.0822 23.7093 24.7032 23.3313L23.6752 22.3043Z" fill="currentColor"/>
		</svg>);
}
function TriangleIcon(_a) {
    var _b = _a.size, size = _b === void 0 ? 24 : _b;
    return (<svg width={size} height={size} fill="currentColor" viewBox="0 0 24 24">
			<path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M18.25 12L5.75 5.75V18.25L18.25 12Z"/>
		</svg>);
}
function TrophyIcon(_a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.size, size = _c === void 0 ? 24 : _c;
    return (<svg width={size} height={size} fill="none" viewBox="0 0 24 24">
			<path d="M7.75 4.75h8.5V11a4.25 4.25 0 01-8.5 0V4.75zM16.5 6.75h.104a2.646 2.646 0 01.904 5.133l-1.008.367M7.5 6.75h-.104a2.646 2.646 0 00-.904 5.133l1.008.367M12 15.5V19M8.75 19.25h6.5" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"/>
		</svg>);
}
function StarIcon(_a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.size, size = _c === void 0 ? 24 : _c;
    return (<svg width={size} height={size} fill="none" viewBox="0 0 24 24">
			<path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"/>
		</svg>);
}
function TwitchIcon(_a) {
    var _b = _a.size, size = _b === void 0 ? 24 : _b, _c = _a.title, title = _c === void 0 ? 'Twitch' : _c;
    return (<svg width={size} height={size} fill="none" viewBox="0 0 24 24">
			<title>{title}</title>
			<path d="M18.25 4.75H5.75a1 1 0 00-1 1v9.5a1 1 0 001 1h2v3l3.25-3h6L19.25 14V5.75a1 1 0 00-1-1zM15.25 9.75v2.5M11.25 9.75v2.5" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"/>
		</svg>);
}
function XIcon(_a) {
    var _b = _a.size, size = _b === void 0 ? 24 : _b, _c = _a.title, title = _c === void 0 ? '𝕏' : _c;
    return (<svg width={size} height={size} fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
			<title>{title}</title>
			<path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z"/>
		</svg>);
}
function PocketCastsIcon(_a) {
    var _b = _a.size, size = _b === void 0 ? 24 : _b, _c = _a.title, title = _c === void 0 ? 'Pocket Casts' : _c;
    return (<svg width={size} height={size} fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
			<title>{title}</title>
...
function YoutubeIcon(_a) {
    var _b = _a.size, size = _b === void 0 ? 24 : _b, _c = _a.title, title = _c === void 0 ? 'YouTube' : _c;
    return (<svg width={size} height={size} fill="none" viewBox="0 0 24 24">
			<title>{title}</title>
			<path fill="currentColor" d="M10,15L15.19,12L10,9V15M21.56,7.17C21.69,7.64 21.78,8.27 21.84,9.07C21.91,9.87 21.94,10.56 21.94,11.16L22,12C22,14.19 21.84,15.8 21.56,16.83C21.31,17.73 20.73,18.31 19.83,18.56C19.36,18.69 18.5,18.78 17.18,18.84C15.88,18.91 14.69,18.94 13.59,18.94L12,19C7.81,19 5.2,18.84 4.17,18.56C3.27,18.31 2.69,17.73 2.44,16.83C2.31,16.36 2.22,15.73 2.16,14.93C2.09,14.13 2.06,13.44 2.06,12.84L2,12C2,9.81 2.16,8.2 2.44,7.17C2.69,6.27 3.27,5.69 4.17,5.44C4.64,5.31 5.5,5.22 6.82,5.16C8.12,5.09 9.31,5.06 10.41,5.06L12,5C16.19,5 18.8,5.16 19.83,5.44C20.73,5.69 21.31,6.27 21.56,7.17Z"/>
		</svg>);
}
function RefreshIcon(_a) {
    var _b = _a.size, size = _b === void 0 ? 24 : _b, _c = _a.title, title = _c === void 0 ? 'Refresh' : _c;
    return (<svg width={size} height={size} fill="none" viewBox="0 0 24 24">
			<title>{title}</title>
...
function AlarmIcon(_a) {
    var _b = _a.size, size = _b === void 0 ? 24 : _b, _c = _a.title, title = _c === void 0 ? 'Alarm' : _c;
    return (<svg width={size} height={size} fill="none" viewBox="0 0 24 24">
			<title>{title}</title>
...
function PasskeyIcon(_a) {
    var _b = _a.size, size = _b === void 0 ? 24 : _b, _c = _a.title, title = _c === void 0 ? 'Passkey' : _c;
    return (<svg xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve" viewBox="0 0 216 216" width={size} height={size} fill="currentColor">
			<title>{title}</title>
			<path d="M172.32 96.79c0 13.78-8.48 25.5-20.29 29.78l7.14 11.83-10.57 13 10.57 12.71-17.04 22.87-12.01-12.82V125.7c-10.68-4.85-18.15-15.97-18.15-28.91 0-17.4 13.51-31.51 30.18-31.51 16.66 0 30.17 14.11 30.17 31.51zm-30.18 4.82c4.02 0 7.28-3.4 7.28-7.6 0-4.2-3.26-7.61-7.28-7.61s-7.28 3.4-7.28 7.61c-.01 4.2 3.26 7.6 7.28 7.6z" style={{
            fillRule: 'evenodd',
            clipRule: 'evenodd',
        }} fill="currentColor"/>
			<path d="M172.41 96.88c0 13.62-8.25 25.23-19.83 29.67l6.58 11.84-9.73 13 9.73 12.71-17.03 23.05v-85.54c4.02 0 7.28-3.41 7.28-7.6 0-4.2-3.26-7.61-7.28-7.61V65.28c16.73 0 30.28 14.15 30.28 31.6zM120.24 131.43c-9.75-8-16.3-20.3-17.2-34.27H50.8c-10.96 0-19.84 9.01-19.84 20.13v25.17c0 5.56 4.44 10.07 9.92 10.07h69.44c5.48 0 9.92-4.51 9.92-10.07v-11.03z" fill="currentColor"/>
			<path d="M73.16 91.13c-2.42-.46-4.82-.89-7.11-1.86-8.65-3.63-13.69-10.32-15.32-19.77-1.12-6.47-.59-12.87 2.03-18.92 3.72-8.6 10.39-13.26 19.15-14.84 5.24-.94 10.46-.73 15.5 1.15 7.59 2.82 12.68 8.26 15.03 16.24 2.38 8.05 2.03 16.1-1.56 23.72-3.72 7.96-10.21 12.23-18.42 13.9-.68.14-1.37.27-2.05.41-2.41-.03-4.83-.03-7.25-.03z" fill="currentColor"/>
		</svg>);
}
