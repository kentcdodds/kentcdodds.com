...
exports.createPasswordForUser = createPasswordForUser;
...
function checkIsCommonPassword(password) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, prefix, suffix, controller_1, timeoutId, response, data, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    timeoutId = setTimeout(function () { return controller_1.abort(); }, 1000);
                    return [4 /*yield*/, fetch("https://api.pwnedpasswords.com/range/".concat(prefix), { signal: controller_1.signal })];
                case 2:
                    response = _b.sent();
...
function signupWithPassword(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, getPasswordHash(password)];
                case 2:
                    hashedPassword = _c.sent();
                    return [4 /*yield*/, prisma_server_ts_1.prisma.user.create({
                            data: __assign({ email: email.toLowerCase(), firstName: firstName }, (lastName && { lastName: lastName })),
...
function createPasswordForUser(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var hashedPassword;
