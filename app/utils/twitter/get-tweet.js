...
var TwitterApiError = /** @class */ (function (_super) {
    __extends(TwitterApiError, _super);
    function TwitterApiError(_a) {
        var message = _a.message, status = _a.status, data = _a.data;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    res = _c.sent();
                    isJson = (_b = res.headers.get('content-type')) === null || _b === void 0 ? void 0 : _b.includes('application/json');
