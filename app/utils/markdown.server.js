...
exports.markdownToHtmlUnwrapped = markdownToHtmlUnwrapped;
exports.markdownToHtmlDocument = markdownToHtmlDocument;
exports.stripHtml = stripHtml;
var hast_util_to_string_1 = require("hast-util-to-string");
var rehype_document_1 = require("rehype-document");
...
function markdownToHtmlUnwrapped(markdownString) {
    return __awaiter(this, void 0, void 0, function () {
        var wrapped;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, markdownToHtml(markdownString)];
                case 1:
                    wrapped = _a.sent();
                    return [2 /*return*/, wrapped.replace(/(^<p>|<\/p>$)/g, '')];
            }
        });
    });
}
function markdownToHtmlDocument(markdownString) {
    return __awaiter(this, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
function stripHtml(htmlString) {
    return __awaiter(this, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            result = (0, unified_1.unified)().use(rehype_parse_1.default).parse(htmlString);
            return [2 /*return*/, (0, hast_util_to_string_1.toString)(result)];
        });
    });
}
