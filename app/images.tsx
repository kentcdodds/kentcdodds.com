...
function getSocialImageWithPreTitle({
  ...
  const titleSection = `co_white,c_fit,g_north_west,w_$gw_mul_14,h_$gh_mul_7,x_$gw_mul_1.5,y_$gh_mul_2.3,l_text:kentcdodds.com:Matter-Regular.woff2_110:${encodedTitle}`
